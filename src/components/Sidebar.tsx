...
const Sidebar: React.FC = () => {
  return (
    <div className="w-[260px] bg-gray-800  h-screen px-6 py-10 flex flex-col justify-between">
      <div>
        <div className="flex">
      ...
      <Button color="default" as = {Link} href='/' className="w-full flex items-center px-4 py-3 rounded-lg text-white bg-gray-800 hover:bg-gray-600 transition">
